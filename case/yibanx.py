...
def test_03(Login):
    ...
    if num =="共 0 条":
        ...
        if title in grade_title:
            # 选择性别
            wk.click('xpath',
                     '//*[@id="app"]/div/div[2]/div/div[1]/div/div/div/div/div[2]/form/div[1]/div/div/div/div/input')
            sexs = [sex1, sex2]
            sex = choice(sexs)
            ...
            years = [years_of_working_1, years_of_working_2, years_of_working_3, years_of_working_4, years_of_working_5,
                     years_of_working_6]
            year = choice(years)
            log.info(year)
            wk.wait(1)
            ...
            # 选择职务
            wk.click('xpath',
                     '//*[@id="app"]/div/div[2]/div/div[1]/div/div/div/div/div[2]/form/div[6]/div/div/div/div[1]/input')
            ...
            # 选择岗位性质
            wk.click('xpath',
                     '//*[@id="app"]/div/div[2]/div/div[1]/div/div/div/div/div[2]/form/div[7]/div/div/div/div[1]/input')
            ...
            # 选择婚姻状况
            wk.click('xpath',
                     '//*[@id="app"]/div/div[2]/div/div[1]/div/div/div/div/div[2]/form/div[8]/div/div/div/div[1]/input')
            ...
            #选择年龄
            wk.click('xpath',
                     '//*[@id="app"]/div/div[2]/div/div[1]/div/div/div/div/div[2]/form/div[2]/div/div/div/div[1]/input')
            ages = [age1, age2, age3, age4]
            age = choice(ages)
            ck_l = wk.web_el_wait('xpath', age)
            log.info(age)
            wk.wait(1)
            ck_l.click()
            wk.wait(1)
            ...
            educations = [education1, education2, education3, education4,education5,education6,education7,education8,education9,education10]
            education = choice(educations)
            ck_l = wk.web_el_wait('xpath', education)
            log.info(education)
            wk.wait(1)
            ck_l.click()
            wk.wait(1)
